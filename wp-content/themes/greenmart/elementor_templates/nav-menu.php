...
$render_get_toggle_menu 		= $this->render_get_toggle_menu();
$render_canvas_button_menu 		= $this->render_canvas_button_menu();
$render_get_toggle_canvas_menu 	= $this->render_get_toggle_canvas_menu();
$render_get_inside_title_menu 	= $this->render_get_inside_title_menu();
?>
<div <?php echo trim($this->get_render_attribute_string('wrapper')); ?>>
	<?php echo trim($render_get_toggle_menu); ?>
	
	<?php echo trim($render_canvas_button_menu); ?>

	<?php if ( isset($type_menu) && $type_menu !== 'none' ) echo '<div '. trim($this->get_render_attribute_string('content-class')) .' >'; ?>
		<?php echo trim($render_get_toggle_canvas_menu); ?>
		<?php echo trim($render_get_inside_title_menu); ?>
